...
const SITE_TITLE = 'Bloggen chatbot supabase';

const homeSchema: WithContext<WebSite> = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Bloggen chatbot supabase',
    alternateName: ['bloggen chatbot supabase', 'Bloggen SEO Template', 'Bloggen Agency Starter', 'Bloggen Agency Template'],
    description:
